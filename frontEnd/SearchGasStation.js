...
function SelectStIdLogo(stId, name){
    if(stId =='GS'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/GS.png'>"
                + name + "</a></div>";
    }
    else if(stId =='SK'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/SK.png'>"
                + name + "</a></div>";
    }
    else if(stId =='S-Oil'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/S-OIL.png'>"
                + name + "</a></div>";
    }
    else if(stId =='오일뱅크'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/hyundai.png'>"
                + name + "</a></div>";
    }
    else if(stId =='NH-OIL'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/nh.png'>"
                + name + "</a> </div>";
    }
    else if(stId =='알뜰'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/알뜰.png'>"
                + name + "</a></div>";
    }
    else if(stId =='ex-OIL'){
        return "<div class='main__ResultList'> <a href='./gasSTDView' data-link>"
                + "<div class='main__ResultList__Title'>"
                + "<img class='main__ResultList__Title_Logo' src = 'img/GasStation_Image/ex.png'>"
                + name + "</a></div>";
    }
    else return null;
}
